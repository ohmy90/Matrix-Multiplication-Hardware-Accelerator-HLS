...
#include "matrix_mul_HLS.h"

#define BLK_ROW 32 //change from 16 to 32
#define A_BLK_NUM DATA_SIZE/BLK_ROW
#define B_BLK_NUM DATA_SIZE/BLK_ROW

void mmult_hw(int* in1, int* in2, int* out, int dim)
{
    buf_t Abuf[BLK_ROW][DATA_SIZE]; //data access optimization by creating local arrays, increasing BLK_ROW helps locality
